    ...
    veryOldInventors = inventors.filter((oldyear) => {

        return oldyear.year >=1500 
        &&
         oldyear.year <=1600 ;
    ...
    // Enter your solution code here:
        ...
        inventorNames = inventors.map(inventorNames => {
                ...
                first = inventorNames.first;
                last = inventorNames.last
    ...
    // Array.prototype.sort()
        ...
        // Enter your solution code here:
            ...
            sortedByBirthYear = inventors.sort((s,e)=>{
        ...
        // 8. Use Array.prototype.find() to identify and retrieve the comment object with a
        //  specific ID 823423 from an array of comment objects.
        ...
        // Enter your solution code here:
                ...
                commentById = comments.find((comit) =>{

                       return comit.id  === 823423;
                    }
                )
        ...
        idx = comments.findIndex(index => index.id === 123523);
